...
class ANA_utils {
 ...
 public :
  ...
  void Get_Tau_Info(Pythia8::Event event, std::vector<int> vecboson_index, std::vector<TruthPart>* p_Tau_Coll, std::vector<TruthPart>* p_AntiTau_Coll, std::vector<TruthPart>* p_TauDecay_Coll, std::vector<TruthPart>* p_AntiTauDecay_Coll, std::vector<TruthPart>* p_Corr_Plus, std::vector<TruthPart>* p_Corr_Minus);
};
